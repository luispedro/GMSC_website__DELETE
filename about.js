...
var $author$project$About$content = A2(
	$elm$html$Html$span,
	_List_fromArray(
		[
...
var $author$project$About$footer = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$id('footerbar')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Copyright (c) 2023 GMSC authors. All rights reserved.')
				]))
		]));
...
var $author$project$About$header = function () {
	var link = F2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2(link, '/home/', 'Home'),
						A2(link, '/browse_data/', 'Browse'),
						A2(link, '/downloads/', 'Downloads'),
						A2(link, '/help/', 'Help'),
						A2(link, '/about/', 'About&Contact')
					]))
			]));
}();
...
var $rundis$elm_bootstrap$Bootstrap$CDN$stylesheet = A3(
	...
	_List_Nil);
var $author$project$About$main = $elm$browser$Browser$document(
	{
		init: function (_v0) {
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$author$project$About$header,
												$author$project$About$content,
												A2($elm$html$Html$hr, _List_Nil, _List_Nil),
												$author$project$About$footer
											]))
									]))
							]))
					]),

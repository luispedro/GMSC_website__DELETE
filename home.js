...
var $author$project$Home$content_geo = A2(
	$elm$html$Html$span,
	_List_fromArray(
		[
...
var $author$project$Home$content_habitat = A2(
	$elm$html$Html$span,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$id('content')
...
var $author$project$Home$content_taxonomy = A2(
	$elm$html$Html$span,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$id('content')
...
var $author$project$Home$footer = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
...
var $author$project$Home$header = function () {
	var link = F2(
...
var $author$project$Home$intro = A2(
	$elm$html$Html$span,
	_List_fromArray(
		[
...
var $rundis$elm_bootstrap$Bootstrap$CDN$stylesheet = A3(
	...
	_List_Nil);
var $author$project$Home$main = $elm$browser$Browser$document(
	{
		init: function (_v0) {
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$author$project$Home$header,
												$author$project$Home$intro,
												$author$project$Home$content_geo,
												$author$project$Home$content_habitat,
												$author$project$Home$content_taxonomy,
